...
function BhaktapurExtend() {
  ...
  return (
    <div className="p-4 max-w-6xl mx-auto">
      <h1 className="text-2xl font-bold mb-6 text-gray-800">Extended Bookings - Bhaktapur</h1>
          ...
          <ul className="divide-y divide-gray-200">
            {extendedBookings.length > 0 ? (
              ...
              <li className="px-6 py-8 text-center text-gray-500">
                No valid extended bookings found for Bhaktapur
              </li>
            )}
          </ul>
        </div>
...
export default BhaktapurExtend;
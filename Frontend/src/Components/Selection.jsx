  ...
  function Selection() {
    ...
    const handleBooking = () => {
      ...
      let totalCost = 0;
      const peakRate = 20; // ₹25 per hour (10 AM - 5 PM)
      const offPeakRate = 25; // ₹15 per hour (before 10 AM, after 5 PM)
      ...
      while (currentTime < endTotalMinutes) {
        ...
        let rate = (currentHour >= 10 && currentHour < 17) ? peakRate : offPeakRate;
        ...
        totalCost += (rate / 60) * chargeableMinutes;
      ...
      console.log(`Booking has been confirmed! Total Cost: Rs.${totalCost}`);
